      ...
      <div className="max-w-4xl mx-auto px-4 py-2.5 sm:py-3 flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-2 group">
          ...
          <div className="hidden sm:block">
            <h1 className="text-lg sm:text-xl font-black bg-gradient-to-r from-purple-600 to-pink-500 gradient-text">
              Gina 学英语
            </h1>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          {/* Streak */}
          <div className="flex items-center gap-1 bg-orange-50 px-3 py-1.5 rounded-full border-2 border-orange-100">
            <span className="text-base sm:text-lg">🔥</span>
            <span className="text-sm font-black text-orange-600">{streak}</span>
          </div>

          {/* Today progress */}
          <div className="hidden sm:flex items-center gap-1.5 bg-green-50 px-3 py-1.5 rounded-full border-2 border-green-100">
          ...
          <select
            ...
            className="text-sm font-bold bg-white border-2 border-purple-200 rounded-xl px-3 py-1.5 outline-none focus:border-purple-400 transition-colors cursor-pointer"
          >
